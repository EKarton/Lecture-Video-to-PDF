...
class TimeUtilsTests(unittest.TestCase):
    ...
    def test_given_timestamp_ms_with_hours_it_should_convert_to_timestamp_ms_correctly(self):
    ...
    def test_given_time_minutes_or_hours_it_should_convert_to_timestamp_ms_correctly(self):
